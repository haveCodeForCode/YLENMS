package com.ylenms.common.constant;
...
public class UserConstants
{
     ...
     * SN码限制
     */
    public static final String SN_UNIQUE="0";
    public static final String SN_NOT_UNIQUE="1";
    
    /**
     * 设备名称限制
     */
    public static final String DEVNAME_UNIQUE="0";
    public static final String DEVNAME_NOT_UNIQUE="1";
    
    /**
     * 模版名称限制
     */
    public static final String TEMPLATENAME_UNIQUE="0";
    public static final String TEMPLATENAME_NOT_UNIQUE="1";
}
